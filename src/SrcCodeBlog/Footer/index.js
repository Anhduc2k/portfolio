    ...
    <ContainerFooter className="footer">
      <section>
        ...
        <div className="contact">
          ...
          <a href="https://www.facebook.com/duclapulga" target="_blank" rel="noreferrer">
            <i className="fa fa-facebook-square" aria-hidden />
          </a>
          <a href="https://github.com/Anhduc2k" target="_blank" rel="noreferrer">
            <i className="fa fa-github" aria-hidden />
          </a>
          <a href="mailto:duclapulga@gmail.com">
